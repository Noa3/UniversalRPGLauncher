...
|K-032 remains IN PROGRESS; K-033 through K-039 and K-042/K-049 are DONE — RM2K has exactly two page switch slots (A/B), each referencing arbitrary global switch IDs. Item conditions now use bounded inventory counts; actor conditions use bounded party membership. Timer conditions remain fail-closed until deterministic timer state exists. Foreign JavaScript/Ruby/native plugins remain non-executable.|
