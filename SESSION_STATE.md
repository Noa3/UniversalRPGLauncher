...
|K-032 remains IN PROGRESS; K-033 through K-039 and K-042/K-048 are DONE — official LMU page metadata now distinguishes MoveRoute (`0x29`) from EventCommands (`0x34`, with legacy fallback), preventing false capability reporting. Unsupported commands remain diagnostic-only. Foreign JavaScript/Ruby/native plugins remain non-executable.|
